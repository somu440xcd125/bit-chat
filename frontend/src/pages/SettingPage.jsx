...
<div className="rounded-xl border border-base-300 overflow-hidden bg-base-100 shadow-lg p-4">
  {/* Chat Header */}
  ...
  <div className="p-3 border-t border-base-300 flex items-center gap-2">
    <input
      type="text"
      className="w-full p-2 rounded-lg bg-base-200 text-base-content placeholder-base-content/60 text-sm"
      placeholder="This is a preview"
      disabled
    />
    <button className="bg-primary text-primary-content p-2 rounded-lg">➤</button>
  </div>
</div>
